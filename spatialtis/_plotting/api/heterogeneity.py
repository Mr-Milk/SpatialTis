...
from spatialtis._plotting.base import bar_static, violin_static
...
def spatial_heterogeneity(
    ...
    **kwargs,
    ...
    Args:
        ...
        **kwargs: Pass to :class:`spatialtis._plotting.base.violin_static` or
            :class:`spatialtis._plotting.base.bar_static`
