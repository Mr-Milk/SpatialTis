...
def neighborhood_analysis(
    ...
    **kwargs,
    ...
    Args:
        ...
        **kwargs: Pass to :class:`spatialtis._plotting.base.dot_matrix`,
            :class:`spatialtis._plotting.base.heatmap`,
            :class:`spatialtis._plotting.base.graph_layout_static` or
            :class:`spatialtis._plotting.base.graph_layout_interactive`
    ...
    if use == "heatmap":
        ...
        if use == "dot_matrix":
            try:
                ...
                raise Exception(
                    "Please run cell_components before _plotting the dot matrix plot"
                )
            corr = {}
