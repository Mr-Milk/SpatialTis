...
from spatialtis._plotting.base import (
    dot_plot,
    heatmap,
...
def cell_components(
    ...
    **kwargs,
    ...
    Args:
        ...
        **kwargs: Pass to :class:`spatialtis._plotting.base.stacked_bar_static` or
            :class:`spatialtis._plotting.base.stacked_bar_interactive`
...
def cell_density(
    ...
    **kwargs,
    ...
    Args:
        ...
        selected_types: {selected_types}
        key: {key}
        **kwargs: Pass to :class:`spatialtis._plotting.base.violin_static`
...
def cell_co_occurrence(
    ...
    **kwargs,
    ...
    Args:
        ...
        key: {key}
        **kwargs: Pass to :class:`spatialtis._plotting.base.dot_plot` or
